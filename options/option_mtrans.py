...
def get_args_parser():
    parser = argparse.ArgumentParser(description='Mask Transformer',
                                     add_help=True,
    ...
    parser.add_argument('--out-dir', type=str, default='output/mtrans', help='output directory')    
    ...
    # alignment
    parser.add_argument('--align-temp', default=0.1, type=float, help="")
    parser.add_argument('--align-w', default=1.0, type=float, help="")
