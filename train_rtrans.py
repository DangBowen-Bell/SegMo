...
from options.option_rtrans import get_args_parser
from dataset.dataset_t2m import Text2MotionDataset
from models.trans import ResidualTransformer
from models.trainer import ResidualTransformerTrainer
...
if __name__ == '__main__':
    ...
    args.num_quantizers = args_vq.num_quantizers
    args.shared_codebook = args_vq.shared_codebook
    ...
    if args.mtrans_name != '':
        ...
        t2m_trans = None
        print("No mask transformer loaded.")
    ...
    trainer = ResidualTransformerTrainer(args, t2m_trans, res_trans, vq_model, text_model)
